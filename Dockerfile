...
RUN apk add --update apache2 php-apache2 php-mysql php-zip php-xml php-zlib php-opcache php-pdo_odbc php-soap php-pgsql php-pdo php-json php-mcrypt php-openssl shadow && \
  rm -rf /var/cache/apk/*
